...
import getReceptionAPI from '../../api/getReceptionAPI'; // Update import path

const ReceptionDetails = () => {
    const { receptionId } = useParams(); // Extract receptionId from the URL
    ...
    useEffect(() => {
        const fetchReceptionDetails = async () => {
            try {
                ...
                setReceptionData(data.data); // Access the 'data' property as per the response structure
            } catch (err) {
